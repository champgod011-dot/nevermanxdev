...
pcall(function()
    ...
    Btn.Position                = UDim2.new(1, -74, 0.5, -29)
    ...
    Glow.Size                   = UDim2.new(0.7, 0, 0, 3)
    Glow.Position               = UDim2.new(0.15, 0, 1, 4)
    ...
    UserInputService.InputChanged:Connect(function(input)
        ...
        or input.UserInputType == Enum.UserInputType.MouseMovement then
            ...
            local newX = math.clamp(startPos.X.Offset + delta.X, 6, vp.X - 64)
            local newY = math.clamp(startPos.Y.Offset + delta.Y, 6, vp.Y - 64)
    ...
    local function playPressAnim()
        ...
        TweenService:Create(Glow,   TweenInfo.new(0.08), { BackgroundTransparency = 0 }):Play()
    end

    local function playReleaseAnim()
        -- ปล่อย: คืนขนาด
        ...
        TweenService:Create(Glow,   TweenInfo.new(0.15), { BackgroundTransparency = 0.4 }):Play()
    end

    Btn.MouseButton1Down:Connect(playPressAnim)
    ...
    -- Touch (mobile)
    Btn.TouchLongPress:Connect(function() end)  -- absorb long press
